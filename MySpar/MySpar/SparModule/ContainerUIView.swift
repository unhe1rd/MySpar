...
final class ContainerUIView: UIViewController, UITabBarDelegate {
...
extension ContainerUIView: SparViewInput{
...
extension ContainerUIView: UIScrollViewDelegate {
    
}

extension ContainerUIView: UICollectionViewDataSource {
...
extension ContainerUIView: UICollectionViewDelegateFlowLayout {
